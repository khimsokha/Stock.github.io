                    ...
                    <div class="dasble">
                        ...
                        <table id="customers">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="control-use-borrow">   
                                    
                                        <a href="./formUse.php?id=<?php echo $row['id'];?>" id="button-take-to-use">ដកប្រើ</a>
                                        <a href="./formBorrow.php?id=<?php echo $row['id'];?>" id="button-borrow">កម្ចី</a>
                                    </div>
